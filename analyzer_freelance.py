...
ターゲット：フリーランス・副業・個人事業主を目指す人、または実践中の人

条件：
- 「過去に反応が良かった投稿」のトーン・構成・言葉遣いを忠実に再現する
- 語りかけるような口語体（〜だった、〜だよね、〜してみてください）
- 具体的な数字や体験談を入れる（月収100万、3年目、1年目など）
- 読者の共感を引き出してから気づきや解決策を提示する流れ
- フリーランス・副業・働き方・お金・マインドセットのテーマで書く
- トレンドのキーワードやテーマを取り入れる
- 朝・昼・夜それぞれに適した内容にする
- 各投稿は200〜400文字（短めでテンポよく）
